            ...
            <div class = "form-row">
                ...
                <div class="form-group col-md-2">
                    <select class="form-control form-control-sm" name="category">
                        ...
                        <option <?= isset($filter) && array_key_exists('category', $filter) && $filter['category'] == "Fejhallgató" ? "Selected" : NULL; ?>>Fejhallgató</option>
                        <option <?= isset($filter) && array_key_exists('category', $filter) && $filter['category'] == "Erősítő" ? "Selected" : NULL; ?>>Erősítő</option>
                        <option <?= isset($filter) && array_key_exists('category', $filter) && $filter['category'] == "Hangkártya" ? "Selected" : NULL; ?>>Hangkártya</option>
